...
import {Card, Row, Col, Badge, Typography, Tag} from 'antd';
import "./Character.scss"

const {Title, Text} = Typography;

const Character = () => {
    const { character, getCharacter, characterLocation, characterEpisodes} = useCharacter();
        ...
        <div>
            ...
            <Row  justify="center">
                <Col xs={24} sm={18} md={16} lg={16} xl={16}>
                    <Badge.Ribbon text={character.status} color={getStatusColor(character.status)}>
                    <Card hoverable>
